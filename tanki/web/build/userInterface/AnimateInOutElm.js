...
var AnimateInOutElm = /** @class */ (function (_super) {
    ...
    AnimateInOutElm.prototype.remove = function () {
    ...
    AnimateInOutElm.prototype.show = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    AnimateInOutElm.prototype.hide = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
    ...
    return AnimateInOutElm;
}(Component));
export default AnimateInOutElm;
